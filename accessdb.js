...
var ACCESSdb = function(dataSrc, options) {
  ...
  //if(this.options.wrkgrpFile)
  //this.options.wrkgrpFile = "Jet OLEDB:System Database="+this.options.wrkgrpFile+";" || "";
  this.options.wrkgrpFile = "Jet OLEDB:Engine Type=4;";
  ...
  try {
		//"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & DataBasePath & ";User ID=Admin;Password=;"
